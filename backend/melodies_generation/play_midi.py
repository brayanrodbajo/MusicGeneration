...
mid_file_one = "bajo_salsa.midi"
mid_file_two = "piano_salsa.midi"
# mid64 = base64.encodestring(open(mid_file, 'rb').read())
# print ("mid64='''\\\n" + mid64 + "'''")
...
def play_music(music_file=mid_file_one):
    """
